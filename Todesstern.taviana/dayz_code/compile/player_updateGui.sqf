...
**      Script:      player_updateGui.sqf                                                                                                           **
**      Credits to:  Dayz Epoch Team and cen                                                                                                                 **
**      Source:      addons\dayz_code\compile\player_updateGui.sqf                                                                                  **
**                                                                                                                                                  **
******************************************************************************************************************************************************
*****************************************************************************************************************************************************/
...
/**/	_ctrlMoneyCash = _display displayCtrl 7101;
/**/	_bankMoney = (player getVariable [Z_bankVariable,0] call BIS_fnc_numberText);
/**/	_cashMoney = (player getVariable [Z_moneyVariable,0] call BIS_fnc_numberText);
/**/	_ctrlMoneyBank ctrlSetText format ["%1",_bankMoney];
/**/	_ctrlMoneyCash ctrlSetText format ["%1",_cashMoney];
/**/	
/**/	//Restarttime
...
/**/
/**/	// Humanity	
/**/	_ctrlHumanityIcon 	= _display displayCtrl 7701;	
/**/	_ctrlHumanityBorder = _display displayCtrl 7702;		
/**/	_ctrlHumanityAmount = _display displayCtrl 7703;
/**/	_ctrlHumanityHL 	= _display displayCtrl 7704;
...
/**/
/**/	// Kill counter
/**/	_ctrlsurvivorKills 	= _display displayCtrl 7400;
/**/	_ctrlhumanKills 	= _display displayCtrl 7401;
/**/	_ctrlbanditKills	= _display displayCtrl 7402;
/**/	_ctrlzombieKills	= _display displayCtrl 7403;
/**/
...
/**/	_ctrlsurvivorKills ctrlSetText str(player getVariable["headShots", 0]);
/************************************************* CUSTOM HUD END ****************************************************************/
