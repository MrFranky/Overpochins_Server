...
DZE_MoneyStorageClasses = [""]; // List of classnames that players can bank with. If you want a specific class name added (i.e Plastic_Pole_EP1_DZ) consult the README.md on github.
...
ZSC_bankObjects = ["VaultStorage"]; // Array of objects that are available for banking (i.e Suitcase, Info_Board_EP1)
