...
{if ((_type isKindOf _x) &&(_part == "PartWheel")) exitWith {_part = "PartWTruck3";};} count ["Kamaz_Base","MTVR","Ural_Base","Ural_Base_withTurret","V3S_Base"];	// LKWs benötigen nun LKW-Reifen
