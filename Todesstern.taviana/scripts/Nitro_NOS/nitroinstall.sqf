...
**      Script:     NOS - nitroinstall.sqf                                                                                                          **
**      Credits to: Sandbird for creation and FallingSheep for sharing                                                                              **
**      Source:     http://opendayz.net/threads/release-nos-for-cars.20620/                                                                         **
**                                                                                                                                                  **
******************************************************************************************************************************************************
*****************************************************************************************************************************************************/
...
if ((PlayerHumanityLevel >= PlayerHumanityLevelNOS) && (_Jerrycan >= 1)&&(_Redbull >= 1)) then {
	...
	_msg = "You need: 1x(Full Jerry Can) and 1x RedBull Soda and Humanity Level "+str(PlayerHumanityLevelNOS)+" to install nitro boost.";
	cutText [_msg, "PLAIN DOWN"];
};