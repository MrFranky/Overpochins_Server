...
*/																		//
private ["_position","_unitcount","_skill","_wpRadius","_xpos","_ypos","_unitGroup","_aiskin","_unit","_weapon","_magazine","_wppos1","_wppos2","_wppos3","_wppos4","_wp1","_wp2","_wp3","_wp4","_wpfin","_unitArrayName","_unitMissionCount","_useDZAI","_giveAT",	"_giveAA", "_configured"];
...
for "_x" from 1 to _unitcount do {
	...
	//Lets spawn the unit
	_newPos = _position findEmptyPosition [0,20,(DZMSHotSpotsBanditSkins select 0)];
