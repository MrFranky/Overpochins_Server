// standard roadblock mission: circle of H-barriers and money crate
...
for "_i" from 1 to _num do {
  _base1 = createVehicle ["Land_HBarrier1_DZ", 
...
_crate = createVehicle ["GuerillaCacheBox",DZMSRoadBlockLootPos,[], 0, "CAN_COLLIDE"];
...
[[(DZMSRoadBlockLootPos select 0) ,(DZMSRoadBlockLootPos select 1), 0],6,3,"DZMSHotSpotsUnitsMinor", true, true] call DZMSHotSpotsAISpawn;
sleep 5;
