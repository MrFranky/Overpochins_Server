// standard hotspot mission: vehicle ammo loot
...
_crate = createVehicle ["USOrdnanceBox_EP1",DZMSHotSpotsLootPos,[], 0, "CAN_COLLIDE"];
[_crate,"vehammo"] ExecVM DZMSHotSpotsBoxSetup;
[_crate] call DZMSHotSpotsProtectObj;

// DZMSHotSpotsAISpawn spawns AI to the mission. Usage: [_coords, count, skillLevel, unitArray]
[[(DZMSHotSpotsLootPos select 0) ,(DZMSHotSpotsLootPos select 1), 0],3,3,"DZMSHotSpotsUnitsMajor",false,true] call DZMSHotSpotsAISpawn;
[[(DZMSHotSpotsLootPos select 0) ,(DZMSHotSpotsLootPos select 1), 0],3,3,"DZMSHotSpotsUnitsMajor",true] call DZMSHotSpotsAISpawn;
sleep 5;
